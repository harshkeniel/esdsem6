...
// const api_url = "https://sem6esd.herokuapp.com/user"
const api_url = "https://sem6esd.herokuapp.com/user"
...
function loadData(records = []) {
	...
	for(let i=0; i<records.length; i++) {
		...
		table_data += `<td>${records[i].complain}</td>`;
		table_data += `<td>`;
...
function postData() {
	...
	data = {name: name, mobile: mobile, city: city, complain: complain};
...
function putData() {
	...
	data = {_id: _id, name: name, mobile: mobile, city: city, complain: complain};
